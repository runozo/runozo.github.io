---
layout: post
title:  "Python quiz n.3 - Count words & others of a file"
...
This time, "the man":{% post_url 2015-01-08-Get-last-line-of-a-text-file-in-Python %} asked this:
...
print('nchar=%s, word_count=%s, line_count=%s\n\nunique_words_count:\n\n%s' %
      (len(lines), lc, len(lines.split('\n')), "\n".join(['%s=%s' % (k, v) for k, v in c.items()])))
{% endhighlight %}
